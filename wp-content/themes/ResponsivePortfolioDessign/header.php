...
.suspend dl dt{width:40px;height:198px;background:url(http://localhost:880/wp-content/themes/ResponsivePortfolioDessign/images/suspend.png);position:absolute;top:0;left:0;cursor:pointer;}
.suspend dl dd.suspendQQ{width:120px;height:85px;background:#ffffff;}
.suspend dl dd.suspendQQ a{width:120px;height:85px;display:block;background:url(http://localhost:880/wp-content/themes/ResponsivePortfolioDessign/images/suspend.png) -40px 0;overflow:hidden;}
.suspend dl dd.suspendTel{width:120px;height:112px;background:#ffffff;border-top:1px solid #e4e8ec;}
.suspend dl dd.suspendTel a{width:120px;height:112px;display:block;background:url(http://localhost:880/wp-content/themes/ResponsivePortfolioDessign/images/suspend.png) -40px -86px;overflow:hidden;}
